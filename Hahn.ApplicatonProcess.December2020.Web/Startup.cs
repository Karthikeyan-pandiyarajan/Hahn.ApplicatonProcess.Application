...
using Hahn.ApplicatonProcess.December2020.Infrastructure.Extensions;
...
namespace Hahn.ApplicatonProcess.December2020.Web
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddMvc();
			services.AddDbContext<ApplicationDbContext>(context => { context.UseInMemoryDatabase("ApplicantManager"); });
